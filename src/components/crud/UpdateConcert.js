...
function UpdateConcert() {
    ...
    async function fetchConcert() {
      try {
        const response = await axios.get(
          `http://localhost:3000/api/concert/${id}`,
          {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:3000/api/update_concert_api/${id}`,
        formData,
        {
          headers: {
  ...
  if (loading)
    return (
      <p style={{ color: "#ffeb3b", textAlign: "center", marginTop: "50px" }}>
      ...
      >
        ...
        {message && (
          <div
            ...
            role="alert"
            style={{
              color: message.includes("Error") ? "#ff5252" : "#cddc39",
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            <label htmlFor="concertName" className="form-label text-white">
              Concert Name
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label htmlFor="venue" className="form-label text-white">
              Venue
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label htmlFor="ticketPrice" className="form-label text-white">
              Ticket Price
            </label>
            <input
              type="number"
          ...
          <div className="mb-3">
            <label htmlFor="availableTickets" className="form-label text-white">
              Available Tickets
            </label>
            <input
              type="number"
          ...
          <div className="mb-3 text-white">
            ...
            {existingImage ? (
              <img
                src={existingImage}
                alt="Concert"
                style={{ maxWidth: "300px", borderRadius: 5 }}
              />
            ) : (
          ...
          <div className="mb-3">
            <label htmlFor="imageFile" className="form-label text-white">
              Change Concert Image (optional)
            </label>
            <input
              type="file"
              className="form-control"
